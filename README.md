...
- [Atlas Job Suite](https://github.com/AHFaria/atlas-suite-job-search-pro-v4-2) structured job search tools built for real world stress including:
  ...
  - [Atlas Role/Title Search](https://github.com/AHFaria/atlas-suite-role-title-assistant-v1-1) a modular prompt for filtering job search results by user-preferred role titles
